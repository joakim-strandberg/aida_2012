package body Aida.Tagged_Bounded_Vector is
   ...
   function Is_Non_Empty (This : T) return Boolean is
     (This.My_Last_Index >= This.First_Index);

   function "=" (L, R : T) return Boolean is
     (Last_Index (L) = Last_Index (R) and then
          (for all I in Index_T range
               Index_T'First .. Last_Index (L) =>
                  L.My_Items (I) = R.My_Items (I)));
