...
package Aida.XML_SAX_Parse_Tests with SPARK_Mode, Elaborate_Body is
...
private
   ...
   type Storage_T is tagged limited record
      Header_Comment : Standard.String (1..100)
        := (others => ' '); -- Not using Aida.Bounded_String at the moment.
      Person  : Json_Parsing_Tests_Model.People_T
        := (others => Json_Parsing_Tests_Model.Person_Def.Make);
   ...
   function Default_Person_Id return Json_Parsing_Tests_Model.Person_Id_T is
     (1);
   ...
   procedure Test_Person_With_Hand_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_1
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_2
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_3
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_4
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_5
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_6
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Hand_7
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Comment_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Age_Pre_Comment_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Age_Post_Comment_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Age_Pre_CDATA_Comment_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Single_Quote_Attribute_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;

   procedure Test_Person_With_Double_Quote_Attribute_0
     (T : in out Ahven.Framework.Test_Case'Class) with
     Global => null;
