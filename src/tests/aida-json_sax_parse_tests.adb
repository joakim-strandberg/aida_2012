...
package body Aida.JSON_SAX_Parse_Tests is
   ...
   package body Test_Person_With_Name_And_Age_Utils with SPARK_Mode is
      ...
      begin
         ...
         Ahven.Assert (Storage.Person (Max_Indices.Person_Id_Max).Name = "bertil", "bc2f314b-46c2-4310-849e-93d3380f0cf3");
         Ahven.Assert (Storage.Person (Max_Indices.Person_Id_Max).Age = 5, "0b99115c-279b-4b51-991f-4fafcb0fd21f");
      end Run_Test;
   ...
   package body Test_Person_With_Hand_Utils with SPARK_Mode is
      ...
      begin
         ...
         if
           (Max_Indices.Hand_Id_Max > 0 and
                Max_Indices.Person_Id_Max > 0) and then (not Storage.Person (Max_Indices.Person_Id_Max).Hands.Is_Empty)
         then
            declare
