...
package body Aida.UTF8.Tests is
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_24 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..1) := (1 => Standard.Character'Val (16#24#));
      Pointer : Integer := 1;
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_C2A2 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..2) := (1 => Standard.Character'Val (16#C2#), 2 => Standard.Character'Val (16#A2#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_E282AC (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..3) := (1 => Standard.Character'Val (16#E2#), 2 => Standard.Character'Val (16#82#), 3 => Standard.Character'Val (16#AC#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_E0AA81 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..3) := (1 => Standard.Character'Val (16#E0#), 2 => Standard.Character'Val (16#AA#), 3 => Standard.Character'Val (16#81#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_F0908D88 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..4) := (1 => Standard.Character'Val (16#F0#), 2 => Standard.Character'Val (16#90#), 3 => Standard.Character'Val (16#8D#), 4 => Standard.Character'Val (16#88#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_F4808081 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..4) := (1 => Standard.Character'Val (16#F4#), 2 => Standard.Character'Val (16#80#), 3 => Standard.Character'Val (16#80#), 4 => Standard.Character'Val (16#81#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
   ...
   procedure Extract_UTF8_Code_Point_Hexadecimal_Case_F3B09081 (T : in out Ahven.Framework.Test_Case'Class) is
      ...
      Source : constant Standard.String (1..4) := (1 => Standard.Character'Val (16#F3#), 2 => Standard.Character'Val (16#B0#), 3 => Standard.Character'Val (16#90#), 4 => Standard.Character'Val (16#81#));
      Pointer : Integer := 1;
      Value : Aida.UTF8_Code_Point.T;
   begin
      Aida.UTF8.Get (Source      => Source,
