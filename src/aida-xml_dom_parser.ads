...
package Aida.XML_DOM_Parser is
   ...
   private
      ...
      function Can_Allocate_Node_Id (This : T) return Boolean is
        (This.Node_Id_Max < Extended_Node_Id_T'Last);

      function Node_Id_Max (This : T) return Extended_Node_Id_T is
        (This.My_Node_Id_Max);

      function Can_Allocate_Attribute_Id (This : T) return Boolean is
        (This.Attribute_Id_Max < Extended_Attribute_Id_T'Last);

      function Attribute_Id_Max (This : T) return Extended_Attribute_Id_T is
        (This.My_Attribute_Id_Max);
   ...
   function Name (This : Attribute_T;
                  Map  : Int_To_String_Map.T) return String with
     Global    => null;
...
private
   ...
   type Attribute_T is tagged limited record
      My_Name_Key       : Int_To_String_Map.Key_T
        := Int_To_String_Map.Key_T'First;

      My_Value_Key      : Int_To_String_Map.Key_T
        := Int_To_String_Map.Key_T'First;

      My_Next_Attribute : Extended_Attribute_Id_T
        := Extended_Attribute_Id_T'First;
   end record;

   function Name (This : Attribute_T;
                  Map  : Int_To_String_Map.T) return String is
     (Map.Value (This.My_Name_Key));

   function Value (This : Attribute_T;
                   Map  : Int_To_String_Map.T) return String is
     (Map.Value (This.My_Value_Key));

   function Next_Attribute (This : Attribute_T) return Attribute_Id_T is
     (This.My_Next_Attribute);

   function Has_Next_Attribute (This : Attribute_T) return Boolean is
     (This.My_Next_Attribute > Extended_Attribute_Id_T'First);
   ...
   type Inner_Node_T (My_Id : Node_Kind_Id_T := Node_Kind_Id_T'First) is record
      ...
      case My_Id is
         when XML_Tag     =>
            My_JSON_Key           : Int_To_String_Map.Key_T
              := Int_To_String_Map.Key_T'First;

            My_First_Child_Node   : Extended_Node_Id_T
              := Extended_Node_Id_T'First;

            My_First_Attribute_Id : Extended_Attribute_Id_T
              := Extended_Attribute_Id_T'First;
   ...
   function Name (This : Node_T;
                  Map  : Int_To_String_Map.T) return String is
     (Map.Value (This.Inner.My_JSON_Key));

   function Comment (This : Node_T;
                     Map  : Int_To_String_Map.T) return String is
     (Map.Value (This.Inner.My_Key));
   ...
   function First_Attribute (This : Node_T) return Attribute_Id_T is
     (This.Inner.My_First_Attribute_Id);

   function Has_Attributes (This : Node_T) return Boolean is
     (This.Inner.My_First_Attribute_Id > Extended_Attribute_Id_T'First);

   function First_Child_Node (This : Node_T) return Node_Id_T is
     (This.Inner.My_First_Child_Node);

   function Has_Child_Nodes (This : Node_T) return Boolean is
     (This.Inner.My_First_Child_Node > Extended_Node_Id_T'First);

   function Next_Node (This : Node_T) return Node_Id_T is
     (This.Inner.My_Next_Node);
   ...
   type Current_Node_T is record
      ...
      --  An xml tag  can have several child tags and
      --  this index points out the last one
   end record;

   function Default_Current_Node return Current_Node_T is
     ((Node_Id           => Node_Id_T'First,
