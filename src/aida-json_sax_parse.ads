...
--
--  An alternative JSON parsing implementation would be
--  to create a Parent type:
--
...
--  implementation of the procedures should be called. Therefore,
--  for performance reasons Dynamic dispatch has been avoided by
--  using a generic procedure for the JSON parsing.
--
...
--  Integer_Value and Real_Value. This leaves the actual parsing
--  of these values to the implementer. This is because unbounded Integers and
--  Reals are part of the JSON standard. If rounding is accepted or not is
--  up to the implementer and so on.
generic
