package Aida with Pure is
   ...
   function Hash32 (This : Int32) return Aida.Hash32_T with
     Global => null;
   -- Calculates the hash of an 32-bit Int32 based upon the following post
   -- on Stackoverlow:
   -- http://stackoverflow.com/questions/664014/what-Int32-hash-function-are-good-that-accepts-an-Int32-hash-key
   --
   ...
   function To_String (This : Int32) return Standard.String with
     Global => null,
     Post   => (if This < 0 then
   ...
   function I (Source : Standard.String;
               Index  : Nat32) return Int32 is (Aida.Character.To_Int32 (Source (Source'First + Index))) with
     ...
     Contract_Cases => (Source'Length = 0 => Has_Failed,
                        ...
                        Source'Length = 2 => (if (for all Index in Source'Range => Aida.Character.Is_Digit (Source (Index))) then
                                                (Has_Failed = False and
                                                  ...
                                                  elsif ((Source (Source'First) = '-') and (for all Index in Int32 range (Source'First + 1) .. Source'Last => Aida.Character.Is_Digit (Source (Index)))) then
                        ...
                        Source'Length = 10 => (if (for all Index in Source'Range => Aida.Character.Is_Digit (Source (Index))) then
                                                 ...
                                                 (Has_Failed = False and
                                                    Target = -100_000_000*I (Source, 1) - 10_000_000*I (Source, 2) - 1_000_000*I (Source, 3) - 100_000*I (Source, 4) - 10_000*I (Source, 5) - 1_000*I (Source, 6) - 100*I (Source, 7) - 10*I (Source, 8) - I (Source, 9))
                                                     ...
                                                     Has_Failed),
                        Source'Length = 11 => (if ((Source (Source'First) = '-') and (for all Index in Int32 range (Source'First + 1) .. Source'Last => Aida.Character.Is_Digit (Source (Index)))) then
   ...
   function To_Int32 (Source : Standard.String) return Int32 with
     ...
     Pre => ((Source'Length >= 1 and Source'Length <= 11) and then (
                 ...
                 ((for all Index in Source'Range => Aida.Character.Is_Digit (Source (Index))) or
                    ((Source (Source'First) = '-') and (for all Index in Int32 range (Source'First + 1) .. Source'Last => Aida.Character.Is_Digit (Source (Index)))))
               elsif Source'Length = 10 then
                 (((Source (Source'First) = '-') and (for all Index in Int32 range (Source'First + 1) .. Source'Last => Aida.Character.Is_Digit (Source (Index)))) or
               ...
               (((Source (Source'First) = '-') and (for all Index in Int32 range (Source'First + 1) .. Source'Last => Aida.Character.Is_Digit (Source (Index)))) and then
                    ((Source(Source'First + 1) = '2' and
                         Source(Source'First + 2) = '1' and
                         Source(Source'First + 3) = '4' and
                         Source(Source'First + 4) = '7' and
