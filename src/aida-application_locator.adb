...
package body Aida.Application_Locator is
   ...
   function Get_Executable_Directory (Has_Failed_To_Find_Executable_Directory : out Boolean) return Standard.String
   is
      Current_Directory                : constant Standard.String := Aida.Directories.Current_Directory;
      Simple_Name_Of_Current_Directory : constant Standard.String := Aida.Directories.Simple_Name (Current_Directory);
   begin
      ...
      declare
         Potential_Executable_Directory : constant Standard.String := Current_Directory & Aida.OS_Lib.Directory_Separator & "bin";
      begin
