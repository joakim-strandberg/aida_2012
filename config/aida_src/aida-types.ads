...
package Aida.Types with SPARK_Mode is

   use all type Aida.Character.T;

   type Character_T is new Aida.Character.T;
   ...
   type String_T is new Aida.String.T;

   type Hash32_T is new Aida.Hash32.T;
   ...
   function I (Source : String_T;
               Index  : Natural) return Int32_T is (Int32_T (To_Int32 (Aida.Character.T (Source (Source'First + Index))))) with
   Ghost => True,
...
private
   ...
   function To_String (This : Int32_T) return String_T is (String_T (Aida.Int32.To_String (Aida.Int32.T (This))));

   function Hash32 (This : Int32_T) return Hash32_T is (Hash32_T (Aida.Int32.Hash32 (Aida.Int32.T (This))));

   function Hash32 (This : String_T) return Hash32_T is (Hash32_T (Aida.String.Hash32 (Aida.String.T (This))));
